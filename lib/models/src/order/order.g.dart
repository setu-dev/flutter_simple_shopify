...
_$_Order _$$_OrderFromJson(Map<String, dynamic> json) => _$_Order(
      ...
      orderFinancialStatus: json['orderFinancialStatus'] as String,
      orderFulfillmentStatus: json['orderFulfillmentStatus'] as String,
...
Map<String, dynamic> _$$_OrderToJson(_$_Order instance) => <String, dynamic>{
      ...
      'orderFinancialStatus': instance.orderFinancialStatus,
      'orderFulfillmentStatus': instance.orderFulfillmentStatus,
